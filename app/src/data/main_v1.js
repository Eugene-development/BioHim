...
<span class="pb-3 block bg-clip-text text-transparent bg-gradient-to-r from-green-200 to-cyan-400 sm:pb-5">Н<span class="text-lg">2</span>O<span class="text-lg">2</span></span>
</h1>
`;
