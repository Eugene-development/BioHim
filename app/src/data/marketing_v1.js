...
const benefits_1 = [
    {
        value:
            '<strong>Техническая перекись водорода</strong> активно применяется как в профессиональных сферах человеческой деятельности (промышленность, медицина, транспорт) так и в быту. Как правило, вещество используется для отбеливания, дезинфекции и обеззараживания различных поверхностей – мебели, оборудования, тканей, инструментов и прочих немедецинских материалов.'
    },
    {
        value:
